...
\begin{frame}[t]{Stress-Strain equation}\justifying
  On the other hand, the stress tensor, $\mathbf{\sigma}$, is related by the
  strain tensor, $\mathbf{\epsilon}$, through the Stress-Strain equation
  \begin{equation}
    \begin{pmatrix}
      \sigma_{xx}\\
      \sigma_{yy}\\
    ...
    \begin{pmatrix}
      ...
      \epsilon_{yy}\\
      2\epsilon_{xy}
    \end{pmatrix}\label{eq:stress-strain}
  \end{equation}
  or, in matrix form
  \begin{equation}
    \mathbf{\sigma} =  C \mathbf{\epsilon},
    \label{eq:stress-strain-vec}
  \end{equation}
  with
  \begin{equation}
    ...
    \mathbf{\epsilon} = \begin{pmatrix}
      ...
      2\epsilon_{xy}
    \end{pmatrix}.
    \label{eq:sigma-c-epsilon}
  \end{equation}
%  The components of the matrix $C$ are given by the formulas
  \begin{block}{For stress problems}
    Formulas for $c_{ij}$ for stress problems
  \end{block}
  \begin{block}{For strain problems}
    Formulas fot $c_{ij}$ for strain problems
  \end{block}
